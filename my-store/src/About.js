...
export default function About() {
  ...
  return (
   <div>
    <Header />
    <div className='d-flex flex-column' style={{ minHeight: '100vh', backgroundImage: `url(https://lh3.googleusercontent.com/g1gnd4hQOq-ivzhvQeZmj0jy6zOCTGqTAj_NL9Mt46Yts-ddflzpau4RcRA15CGAwfwoOwmAWu4mRRnwN-uySclSM3hGApEptk8nUACiad6wSsLRgQ)`, backgroundSize: 'cover', width: '100vw' }} >
      <div className="container-fluid" style={{ flex: 1 }}>
        <h2 style={{color:"white"}} >About Product Management Software</h2>
        <p style={{ color: 'white' }}>
